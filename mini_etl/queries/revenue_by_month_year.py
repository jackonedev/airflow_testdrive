...
# Prompt
# Sqlite query will return a table with the revenue by month and year. It will have different columns:
...
# 1. tables: olist_orders oo, olist_order_payments oop
# 2. fields: oo.order_id, oo.order_status, oo.order_delivered_customer_date, oo.order_estimated_delivery_date, oop.order_id, oop.payment_installments, oop.payments_value
